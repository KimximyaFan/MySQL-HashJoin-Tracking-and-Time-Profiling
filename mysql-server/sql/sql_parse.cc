...
#include "iterators/_hong.h" // hong

unsigned long long int do_command_count = 0; // hong
unsigned long long int unknown_query_time = 0; // hong
unsigned long long int hash_join_query_time = 0; // hong
struct timespec the_time[2]; // hong

unsigned long long int buffer_store_row_count = 0;              // hong
unsigned long long int key_hasher_operator_2_count = 0;         // hong
unsigned long long int buffer_store_immutable_string_count = 0; // hong
unsigned long long int hash_join_buffer_store_row_time = 0;     // hong
struct timespec the_time_2[2]; // hong

unsigned long long int read_row_from_probe_iterator_count = 0;            // hong
unsigned long long int read_next_joined_row_from_hashtable_count = 0;     // hong
unsigned long long int hash_join_read_row_from_probe_iterator_time = 0;   // hong
unsigned long long int hash_join_read_hashtable_time = 0;                 // hong
unsigned long long int hash_join_total_time = 0;                          // hong
struct timespec the_time_3[2]; // hong


// check internal of ReadRowFromProbeIterator()
unsigned long long int read_row_m_probe_input_read_count = 0;
unsigned long long int read_row_m_probe_input_read_time = 0;
unsigned long long int read_row_result_is_1_count = 0;
unsigned long long int read_row_result_is_1_time = 0;
unsigned long long int read_row_result_is_0_count = 0;
unsigned long long int read_row_result_is_0_time = 0;
unsigned long long int read_row_end_psi_batch_count = 0;
unsigned long long int read_row_end_psi_batch_time = 0;
unsigned long long int read_row_allow_spill_disk_is_true_count = 0;
unsigned long long int read_row_allow_spill_disk_is_true_time = 0;
unsigned long long int read_row_reading_saving_file_is_true_count = 0;
unsigned long long int read_row_reading_saving_file_is_true_time = 0;
unsigned long long int read_row_build_hash_table_is_true_count = 0;
unsigned long long int read_row_build_hash_table_is_true_time = 0;
unsigned long long int read_row_state_setting_count = 0;
unsigned long long int read_row_state_setting_time = 0;
unsigned long long int read_row_total_count = 0;
unsigned long long int read_row_total_time = 0;
struct timespec the_time_4[2]; // hong

unsigned long long int print_lock = 0; // hong


//
bool table_scan_check = false;

unsigned long long int table_scan_iter_condition_is_true_while_count = 0;
unsigned long long int table_scan_iter_condition_is_true_while_time = 0;

unsigned long long int table_scan_iter_condition_is_true_ha_rnd_next_count = 0;
unsigned long long int table_scan_iter_condition_is_true_ha_rnd_next_time = 0;

unsigned long long int table_scan_iter_condition_is_false_while_count = 0;
unsigned long long int table_scan_iter_condition_is_false_while_time = 0;

unsigned long long int table_scan_iter_condition_is_false_ha_rnd_next_count = 0;
unsigned long long int table_scan_iter_condition_is_false_ha_rnd_next_time = 0;

unsigned long long int table_scan_iter_condition_is_false_remainder_count = 0;
unsigned long long int table_scan_iter_condition_is_false_remainder_time = 0;

struct timespec the_time_5[2];
struct timespec the_time_6[2];


// handler.cc, ha_rnd_next()

unsigned long long int ha_rnd_next_has_gcol_time = 0;
unsigned long long int ha_rnd_next_has_gcol_count = 0;

unsigned long long int ha_rnd_next_table_lock_and_rnd_next_time = 0;
unsigned long long int ha_rnd_next_table_lock_and_rnd_next_count = 0;

unsigned long long int ha_rnd_next_update_generated_field_time = 0;
unsigned long long int ha_rnd_next_update_generated_field_count = 0;

unsigned long long int ha_rnd_next_set_row_status_from_handler_time = 0;
unsigned long long int ha_rnd_next_set_row_status_from_handler_count = 0;

struct timespec the_time_7[2];

// ha_innodb, rnd_next()
unsigned long long int innodb_rnd_next_index_first_time = 0;
unsigned long long int innodb_rnd_next_index_first_count = 0;

unsigned long long int innodb_rnd_next_general_fetch_time = 0;
unsigned long long int innodb_rnd_next_general_fetch_count = 0;

struct timespec the_time_8[2];

// ha_innodb, general_fetch()
unsigned long long int row_search_mvcc_time = 0;
unsigned long long int row_search_mvcc_count = 0;

unsigned long long int row_search_no_mvcc_time = 0;
unsigned long long int row_search_no_mvcc_count = 0;

struct timespec the_time_9[2];
...
bool do_command_original(THD *thd); // hong

bool do_command(THD *thd) // hong
{
  clock_gettime(CLOCK_MONOTONIC, &the_time[0]);

  return do_command_original(thd);
}
...
// hong
static void check_secondary_engine_statement_original(THD *thd,
...
static void check_secondary_engine_statement(THD *thd,
  ...
  check_secondary_engine_statement_original(thd, parser_state, query_string, query_length);
  
  clock_gettime(CLOCK_MONOTONIC, &the_time[1]);
  
  if ( do_command_count == 0 )
  {
    Time_Check(the_time, &unknown_query_time, &do_command_count);
    printf("unknown_query_time : %llu\n", unknown_query_time);
  }
  else if ( do_command_count == 1 )
  {
    Time_Check(the_time, &hash_join_query_time, &do_command_count);
    printf("hash_join_query_time : %llu\n", hash_join_query_time);
  }
  printf("======================================================\n");
  printf("do_command_count : %llu\n", do_command_count);

  printf("======================================================\n");
  printf("buffer_store_row_count : %llu\n", buffer_store_row_count);
  printf("key_hasher_operator_2_count : %llu\n", key_hasher_operator_2_count);
  printf("buffer_store_immutable_string_count : %llu\n", buffer_store_immutable_string_count);
  printf("hash_join_buffer_store_row_time : %llu\n", hash_join_buffer_store_row_time);

  printf("======================================================\n");
  printf("read_row_from_probe_iterator_count : %llu\n", read_row_from_probe_iterator_count);
  printf("hash_join_read_row_from_probe_iterator_time : %llu\n", hash_join_read_row_from_probe_iterator_time);
  printf("------\n");

  printf("read_next_joined_row_from_hashtable_count : %llu\n", read_next_joined_row_from_hashtable_count);
  printf("hash_join_read_hashtable_time : %llu\n", hash_join_read_hashtable_time);
  printf("------\n");

  hash_join_total_time = hash_join_read_row_from_probe_iterator_time + hash_join_read_hashtable_time;
  printf("hash_join_total_time : %llu\n", hash_join_total_time);
  printf("------\n");

  printf("======================================================\n");
  printf("Reuslt of ReadRowFromProbeIterator() internal\n");
  printf("======================================================\n");
  printf("read_row_m_probe_input_read_count : %llu\n", read_row_m_probe_input_read_count);
  printf("read_row_m_probe_input_read_time : %llu\n", read_row_m_probe_input_read_time);
  printf("------\n");

  printf("read_row_result_is_1_count : %llu\n", read_row_result_is_1_count);
  printf("read_row_result_is_1_time : %llu\n", read_row_result_is_1_time);
  printf("------\n");

  printf("read_row_result_is_0_count : %llu\n", read_row_result_is_0_count);
  printf("read_row_result_is_0_time : %llu\n", read_row_result_is_0_time);
  printf("------\n");

  printf("read_row_end_psi_batch_count : %llu\n", read_row_end_psi_batch_count);
  printf("read_row_end_psi_batch_time : %llu\n", read_row_end_psi_batch_time);
  printf("------\n");

  printf("read_row_allow_spill_disk_is_true_count : %llu\n", read_row_allow_spill_disk_is_true_count);
  printf("read_row_allow_spill_disk_is_true_time : %llu\n", read_row_allow_spill_disk_is_true_time);
  printf("------\n");

  printf("read_row_reading_saving_file_is_true_count : %llu\n", read_row_reading_saving_file_is_true_count);
  printf("read_row_reading_saving_file_is_true_time : %llu\n", read_row_reading_saving_file_is_true_time);
  printf("------\n");

  printf("read_row_build_hash_table_is_true_count : %llu\n", read_row_build_hash_table_is_true_count);
  printf("read_row_build_hash_table_is_true_time : %llu\n", read_row_build_hash_table_is_true_time);
  printf("------\n");

  printf("read_row_state_setting_count : %llu\n", read_row_state_setting_count);
  printf("read_row_state_setting_time : %llu\n", read_row_state_setting_time);
  printf("------\n");
  printf("------\n");
  printf("Result\n");
  printf("------\n");
  ...
  read_row_total_count = read_row_total_count + read_row_result_is_1_count;
  read_row_total_count = read_row_total_count + read_row_result_is_0_count;
  read_row_total_count = read_row_total_count + read_row_allow_spill_disk_is_true_count;
  read_row_total_count = read_row_total_count + read_row_reading_saving_file_is_true_count;
  read_row_total_count = read_row_total_count + read_row_build_hash_table_is_true_count;
  read_row_total_count = read_row_total_count + read_row_state_setting_count;

  read_row_total_time = read_row_total_time + read_row_m_probe_input_read_time;
  read_row_total_time = read_row_total_time + read_row_result_is_1_time;
  read_row_total_time = read_row_total_time + read_row_result_is_0_time;
  read_row_total_time = read_row_total_time + read_row_end_psi_batch_time;
  read_row_total_time = read_row_total_time + read_row_allow_spill_disk_is_true_time;
  read_row_total_time = read_row_total_time + read_row_reading_saving_file_is_true_time;
  read_row_total_time = read_row_total_time + read_row_build_hash_table_is_true_time;
  read_row_total_time = read_row_total_time + read_row_state_setting_time;


  printf("read_row_total_count : %llu\n", read_row_total_count);
  printf("read_row_total_time : %llu\n", read_row_total_time);
  printf("------\n");
  printf("read_row_from_probe_iterator_count : %llu\n", read_row_from_probe_iterator_count);
  printf("------\n");
  printf("======================================================\n");
  printf("Reuslt of TableScanIterator::Read() internal\n");
  printf("======================================================\n");
  printf("table_scan_iter_condition_is_true_while_count : %llu\n", table_scan_iter_condition_is_true_while_count);
  printf("table_scan_iter_condition_is_true_while_time : %llu\n", table_scan_iter_condition_is_true_while_time);
  printf("------\n");
  printf("table_scan_iter_condition_is_true_ha_rnd_next_count : %llu\n", table_scan_iter_condition_is_true_ha_rnd_next_count);
  printf("table_scan_iter_condition_is_true_ha_rnd_next_time : %llu\n", table_scan_iter_condition_is_true_ha_rnd_next_time);
  printf("------\n");
  printf("table_scan_iter_condition_is_false_while_count : %llu\n", table_scan_iter_condition_is_false_while_count);
  printf("table_scan_iter_condition_is_false_while_time : %llu\n", table_scan_iter_condition_is_false_while_time);
  printf("------\n");
  printf("table_scan_iter_condition_is_false_ha_rnd_next_count : %llu\n", table_scan_iter_condition_is_false_ha_rnd_next_count);
  printf("table_scan_iter_condition_is_false_ha_rnd_next_time : %llu\n", table_scan_iter_condition_is_false_ha_rnd_next_time);
  printf("------\n");
  printf("table_scan_iter_condition_is_false_remainder_count : %llu\n", table_scan_iter_condition_is_false_remainder_count);
  printf("table_scan_iter_condition_is_false_remainder_time : %llu\n", table_scan_iter_condition_is_false_remainder_time);
  printf("------\n");
  printf("======================================================\n");

  printf("======================================================\n");
  printf("Reuslt of handler::ha_rnd_next()\n");
  printf("======================================================\n");
  printf("ha_rnd_next_has_gcol_time : %llu\n", ha_rnd_next_has_gcol_time);
  printf("ha_rnd_next_has_gcol_count : %llu\n", ha_rnd_next_has_gcol_count);
  printf("------\n");
  printf("ha_rnd_next_table_lock_and_rnd_next_time : %llu\n", ha_rnd_next_table_lock_and_rnd_next_time);
  printf("ha_rnd_next_table_lock_and_rnd_next_count : %llu\n", ha_rnd_next_table_lock_and_rnd_next_count);
  printf("------\n");
  printf("ha_rnd_next_update_generated_field_time : %llu\n", ha_rnd_next_update_generated_field_time);
  printf("ha_rnd_next_update_generated_field_count : %llu\n", ha_rnd_next_update_generated_field_count);
  printf("------\n");
  printf("ha_rnd_next_set_row_status_from_handler_time : %llu\n", ha_rnd_next_set_row_status_from_handler_time);
  printf("ha_rnd_next_set_row_status_from_handler_count : %llu\n", ha_rnd_next_set_row_status_from_handler_count);
  printf("------\n");
  printf("======================================================\n");

  printf("======================================================\n");
  printf("Reuslt of ha_innobase::rnd_next()\n");
  printf("======================================================\n");
  printf("innodb_rnd_next_index_first_time : %llu\n", innodb_rnd_next_index_first_time);
  printf("innodb_rnd_next_index_first_count : %llu\n", innodb_rnd_next_index_first_count);
  printf("------\n");
  printf("innodb_rnd_next_general_fetch_time : %llu\n", innodb_rnd_next_general_fetch_time);
  printf("innodb_rnd_next_general_fetch_count : %llu\n", innodb_rnd_next_general_fetch_count);
  printf("------\n");
  printf("======================================================\n");
  printf("row_search_mvcc_time : %llu\n", row_search_mvcc_time);
  printf("row_search_mvcc_count : %llu\n", row_search_mvcc_count);
  printf("------\n");
  printf("row_search_no_mvcc_time : %llu\n", row_search_no_mvcc_time);
  printf("row_search_no_mvcc_count : %llu\n", row_search_no_mvcc_count);
  printf("------\n");
  printf("======================================================\n");
