...
class RowIterator {
 public:
  ...
  explicit RowIterator(THD *thd) : m_thd(thd) {
    //printf("row_iterator.h\nclass RowIterator - RowIterator() .. Constructor \n"); // hong
  }
...
class TableRowIterator : public RowIterator {
 public:
  TableRowIterator(THD *thd, TABLE *table) : RowIterator(thd), m_table(table) {
    //printf("row_iterator.h\nclass TableRowIterator - TableRowIterator() .. Constructor \n"); // hong
  }
 ...
 protected:
  ...
  TABLE *table() const { 
    //printf("row_iterator.h\nclass TableRowIterator - *table() -> TABLE \n"); // hong
    return m_table; }
