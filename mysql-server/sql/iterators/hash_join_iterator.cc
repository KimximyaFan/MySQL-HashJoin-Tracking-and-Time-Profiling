...
#include "_hong.h" // hong
//unsigned long long int hash_join_iterator_read_row_from_probe_iterator_count = 0; // hong
...
HashJoinIterator::HashJoinIterator(
  ...
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - HashJoinIterator() .. Constructor\n"); // hong

  //hong
  table_scan_check = true;
...
bool HashJoinIterator::InitRowBuffer() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - InitRowBuffer() -> bool \n"); // hong
...
bool HashJoinIterator::InitProbeIterator() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - InitProbeIterator() -> bool \n"); // hong
...
bool HashJoinIterator::Init() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - Init() -> bool \n"); // hong
...
bool HashJoinIterator::BuildHashTable() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - BuildHashTable() -> bool \n"); // hong
...
bool HashJoinIterator::ReadNextHashJoinChunk() {
  //printf("1");
  //printf("hash_join_chunk_constructor_count : %d\n", hash_join_chunk_constructor_count);
  //printf("hash_join_chunk_destructor_count : %d\n", hash_join_chunk_destructor_count);
  //printf("hash_join_row_buffer_store_row_count : %d\n", hash_join_row_buffer_store_row_count);
  //printf("hash_join_iterator_read_row_from_probe_iterator_count : %d\n", hash_join_iterator_read_row_from_probe_iterator_count);

  //printf("hash_join_iterator.cc\nclass HashJoinIterator - ReadNextHashJoinChunk() -> bool \n"); // hong
...
bool HashJoinIterator::ReadRowFromProbeIterator() {
  ...
  clock_gettime(CLOCK_MONOTONIC, &the_time_3[0]);
  bool temp = ReadRowFromProbeIterator_Original();
  clock_gettime(CLOCK_MONOTONIC, &the_time_3[1]);

  Time_Check(the_time_3, 
...
bool HashJoinIterator::ReadRowFromProbeIterator_Original() {
  //printf("2");
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - ReadRowFromProbeIterator() -> bool \n"); // hong
  ...
  //print_lock = 100;
  //printf("before m_probe_input->Read()\n");
  clock_gettime(CLOCK_MONOTONIC, &the_time_4[0]);

  
  int result = m_probe_input->Read();
  
  clock_gettime(CLOCK_MONOTONIC, &the_time_4[1]);
  //printf("after m_probe_input->Read()\n");
  //print_lock = 0;

  Time_Check(the_time_4, 
  ...
  if (m_allow_spill_to_disk) {
    //Count_Up(&read_row_allow_spill_disk_is_true);
    clock_gettime(CLOCK_MONOTONIC, &the_time_4[0]);
    m_hash_join_type = HashJoinType::SPILL_TO_DISK;
...
bool HashJoinIterator::ReadRowFromProbeChunkFile() {
  //printf("3");
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - ReadRowFromProbeChunkFile() -> bool \n"); // hong
...
bool HashJoinIterator::ReadRowFromProbeRowSavingFile() {
  //printf("4");
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - ReadRowFromProbeRowSavingFile() -> bool \n"); // hong
...
void HashJoinIterator::LookupProbeRowInHashTable() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - LookupProbeRowInHashTable() \n"); // hong
...
int HashJoinIterator::ReadJoinedRow() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - ReadJoinedRow() -> bool \n"); // hong
...
bool HashJoinIterator::WriteProbeRowToDiskIfApplicable() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - WriteProbeRowToDiskIfApplicable() -> bool \n"); // hong
...
bool HashJoinIterator::JoinedRowPassesExtraConditions() const {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - JoinedRowPassesExtraConditions() -> bool \n"); // hong
...
int HashJoinIterator::ReadNextJoinedRowFromHashTable() {
  clock_gettime(CLOCK_MONOTONIC, &the_time_3[0]);
  int temp = ReadNextJoinedRowFromHashTable_Original();
  clock_gettime(CLOCK_MONOTONIC, &the_time_3[1]);

  Time_Check(the_time_3, &hash_join_read_hashtable_time, &read_next_joined_row_from_hashtable_count);

  return temp;

}

int HashJoinIterator::ReadNextJoinedRowFromHashTable_Original() {
  //printf("5");
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - JoinedRowPassesExtraConditions() -> int \n"); // hong
  int res;
...
int HashJoinIterator::Read() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - Read() -> int \n"); // hong
  for (;;) {
...
bool HashJoinIterator::InitWritingToProbeRowSavingFile() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - InitWritingToProbeRowSavingFile() -> bool \n"); // hong
...
bool HashJoinIterator::InitReadingFromProbeRowSavingFile() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - InitReadingFromProbeRowSavingFile() -> bool \n"); // hong
...
void HashJoinIterator::SetReadingProbeRowState() {
  //printf("hash_join_iterator.cc\nclass HashJoinIterator - SetReadingProbeRowState() \n"); // hong
